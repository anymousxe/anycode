...
const TIPS = [
  ...
  "Place TUI settings in {highlight}~/.config/anycode/tui.json{/highlight} for global config",
  "Add {highlight}$schema{/highlight} to your config for autocomplete in your editor",
  "Configure {highlight}model{/highlight} in config to set your default model",
  "Override any keybind in {highlight}tui.json{/highlight} via the {highlight}keybinds{/highlight} section",
  "Set any keybind to {highlight}none{/highlight} to disable it completely",
  "Configure local or remote MCP servers in the {highlight}mcp{/highlight} config section",
  "AnyCode auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "AnyCode auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "AnyCode uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent AnyCode from reading sensitive files",
  "Use {highlight}anycode run{/highlight} for non-interactive scripting",
  "Use {highlight}anycode --continue{/highlight} to resume the last session",
  "Use {highlight}anycode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}anycode serve{/highlight} for headless API access to AnyCode",
  "Use {highlight}anycode run --attach{/highlight} to connect to a running server",
  "Run {highlight}anycode upgrade{/highlight} to update to the latest version",
  "Run {highlight}anycode auth list{/highlight} to see all configured providers",
  "Run {highlight}anycode agent create{/highlight} for guided agent creation",
  "Use {highlight}/anycode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}anycode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/anycode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}anycode debug config{/highlight} to troubleshoot configuration",
  ...
  "Use {highlight}/connect{/highlight} with AnyCode Zen for curated, tested models",
